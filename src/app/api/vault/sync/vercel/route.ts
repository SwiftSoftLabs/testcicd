...
import { syncProjectToVercel } from '@/lib/vault/vercel-sync';
...
export async function POST(request: Request) {
    try {
        ...
        const result = await syncProjectToVercel(projectId, workspaceId, syncTargetId, user.id);
        ...
        console.error('[vault/sync/vercel POST]', e);
